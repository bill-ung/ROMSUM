...
void romsum( int page );					// Checksum calculation code
...
void print_help( bool help )
{
    ...
    printf( "\n"                                                                      );
    printf( "ROMSUM32 Version 3.1 (2018-01-15)\n"                                     );
